...
function createClientRoutes(manifest, routeModulesCache, initialState, ssr, isSpaMode, parentId = "", routesByParentId = groupRoutesByParentId$1(manifest), needsRevalidation) {
	return (routesByParentId[parentId] || []).map((route) => {
		...
		if (routeModule) {
			...
			dataRoute.loader = async ({ request, params, context, unstable_pattern, unstable_url }, singleFetch) => {
				try {
			...
			dataRoute.action = ({ request, params, context, unstable_pattern, unstable_url }, singleFetch) => {
...
//#endregion
//#region node_modules/react-router/dist/development/chunk-YQSHRJWW.mjs
/**
* react-router v7.14.2
*
* Copyright (c) Remix Software Inc.
...
function createHydratedRouter({ getContext, unstable_instrumentations }) {
	...
	let router2 = createRouter({
		...
		mapRouteProperties,
		future: { unstable_passThroughRequests: ssrInfo.context.future.unstable_passThroughRequests },
